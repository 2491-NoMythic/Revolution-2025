 ...
 */
public class XiaohanArcade extends RobotDriveBase implements Sendable, AutoCloseable {
   ...
   */
  @SuppressWarnings("this-escape")
  public XiaohanArcade(DoubleConsumer leftMotor, DoubleConsumer rightMotor) {
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
    ...
    double rotationsToMeters = 4; // how many rotations of the wheel in a meter
    m_leftOutput = speeds.left * 4 * rotationsToMeters; //4 is the max velocity of the robot in meters per second
    m_rightOutput = speeds.right * 4 * rotationsToMeters; //4 is the max velocity of the robot in meters per second
